...
def home():
    ...
    datas = Post.query.order_by(Post.date_posted.desc()).paginate(page = page, per_page = 5)
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            flash('Logged In Unsuccessful !!!','danger')
...
def user_posts(username):
    ...
    datas = Post.query.filter_by(author = user)\
        .order_by(Post.date_posted.desc())\
        .paginate(page = page, per_page = 5)
    return render_template('user_posts.html',datas=datas, user=user)
